	...
	return (
		<section className='flex flex-col items-center justify-center gap-y-10'>
			...
			<section className=" flex flex-col items-center justify-center gap-3 mt-20">
				...
				<Feature header="Opening a File" bullets={["When you hover over a file type in the tree it will tell you the name","You can click on the icon of the file in the folder to open it", "Alternatively, you can click on the folder to open a modal with all of the files", "Click on a file to open it"]} path="" alttext="instructions"/>
